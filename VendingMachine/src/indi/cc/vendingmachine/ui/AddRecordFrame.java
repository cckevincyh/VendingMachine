...
//零钱补充界面
public class AddRecordFrame extends javax.swing.JDialog {
	    ...
	    /**
			 ...
			 */
			public AddRecordFrame(JDialog owner, String title, boolean modal){
    ...
    private void initComponents() {
      ...
      //构建饮料补充记录模型
        AddRecordModel model = new AddRecordModel(jd);
